// ============================================================
// core/ai/embed/build.gradle.kts — 嵌入模块构建配置
// 作用：声明嵌入模块的构建参数与依赖；承载 EmbeddingProvider 与混合检索
// ============================================================
...
android {                                              // Android 构建配置块
    namespace = "com.memuo.core.ai.embed"              // 包名空间
...
dependencies {                                         // 本模块依赖列表
    implementation(project(":core:db"))                // 依赖数据库模块（KbDao/KbChunk）
    implementation(project(":core:storage"))           // 依赖存储模块（bge 模型目录 StorageProvider）
